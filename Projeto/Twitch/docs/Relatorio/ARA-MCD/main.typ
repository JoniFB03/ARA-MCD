...
Após serem tratados todos, segue-se a análise dos dados recolhidos. Nesta secção iremos dar um maior destaque à rede de ??? /* TODO ver se sim */ porque blablabla. Mais à frente iremos comparar redes de outros idiomas e tirar conclusões mais robustas e sustentadas.
